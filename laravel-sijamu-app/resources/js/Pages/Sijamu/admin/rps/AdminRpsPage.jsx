...
import styles from './AdminRpsPage.module.css';
        ...
        <div className="page-wrapper">
          ...
          <div className={styles.statRow}>
            <div className={`card ${styles.statMini}`}>
              ...
              <div className={styles.statLbl}>Total Mata Kuliah</div>
            </div>
            <div className={`card ${styles.statMini}`}>
              <div className={styles.statNum}>{[...new Set(courses.map((c) => c.prodi))].length}</div>
              <div className={styles.statLbl}>Program Studi</div>
            </div>
            <div className={`card ${styles.statMini}`}>
              <div className={styles.statNum}>{courses.filter((c) => c.rpsFiles && c.rpsFiles.length > 0).length}</div>
              <div className={styles.statLbl}>Sudah Upload RPS</div>
            </div>
            <div className={`card ${styles.statMini}`}>
              <div className={styles.statNum}>{courses.reduce((s, c) => s + c.sks, 0)}</div>
              <div className={styles.statLbl}>Total SKS</div>
            </div>
          </div>
              ...
              <table className="data-table" aria-label="Tabel daftar RPS mata kuliah">
                ...
                <tbody>
                  {filtered.length === 0 ? (
                    ...
                    filtered.map((course) => (
                      <tr key={course.id}>
                        <td><span className={styles.codePill}>{course.code}</span></td>
